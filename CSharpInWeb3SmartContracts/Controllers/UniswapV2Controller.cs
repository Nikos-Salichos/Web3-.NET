...
namespace CSharpInWeb3SmartContracts.Controllers
{
    ...
    public class UniswapV2Controller : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Pair>>> GetUniswapV2allPairsLength()
        {
            try
            {
        ...
        public async Task<ActionResult> UniswapV2RouterGetAmountsOut(long amountIn, List<string> path)
        {
            try
            {
                Account? account = new Account(_user.PrivateKey, Chain.Kovan);
        ...
        public async Task<ActionResult> SwapExactETHForTokens(double amountToSwap, long amountOutMin, [FromBody] List<string> path, double seconds)
        {
            try
            {
                Account? account = new Account(_user.PrivateKey, Chain.Kovan);
